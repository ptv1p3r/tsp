...
\begin{document}
	...
	\section{2-Opt} 
			...
			As intersecções estão a ser detectadas com a definição de intersecção de dois segmentos de recta, que nos diz que tendo dois segmentos de recta AB e o segmento CD, existe intersecção se A estiver de um lado de CD e B do outro, e C estiver de um lado de AB e D do outro.
